...
class AnimeGunCat(Resource):
    def cat(self,catName):
    ...
    def get(self,startLetter):
        if startLetter != '':
            return self.cat(startLetter), 200
        return "Hiba valamit beneztel Senpai", 404

class AnimeGunInfoPage(Resource):
    def titlePage(self,nameUrl):
    ...
    def get(self,animePageInfo):
        if animePageInfo != '':
            return self.titlePage(animePageInfo), 200
        return "Hiba valamit beneztel Senpai", 404

class AnimeGunSearch(Resource):
    ...
    def get(self,searchText):
        if searchText != '':
            return self.search(searchText), 200
        return "Hiba valamit beneztel Senpai", 404

api.add_resource(AnimeGunCat, "/animeguncategory/<string:startLetter>")
api.add_resource(AnimeGunInfoPage, "/animeguninfopage/<string:animePageInfo>")
api.add_resource(AnimeGunSearch, "/animegunsearch/<string:searchText>")
